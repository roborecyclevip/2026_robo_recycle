...
def run_20_mm_accuracy_test(ser, z_coor):
    print(f"We are attempting the 20mm test from 20 x 20 mm to 220 x 220 mm at z of {z_coor}")

    # Previous coordinates used to make travel into a process
    # of UP, FORWARD, DOWN. Like a claw machine.
    prev_x = 20
    prev_y = 20
    for x_coor in range(20, 220, 20):
        for y_coor in range(20, 220, 20):
...
def main():
    ...
    try:
        ...
        run_20_mm_accuracy_test(ser, z_coor)
    finally:
        ser.close()
